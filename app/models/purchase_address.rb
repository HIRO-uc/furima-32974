class PurchaseAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, shipping_prefecture_id: shipping_prefecture_id, city: city, house_number: house_number, building_name: building_name, tel: tel)
  end
end